...
# - Uses existing VPC, public subnets, and private subnets
...
# - You have an existing VPC with established networking
# - You need to integrate with existing infrastructure
# - Your organization has standardized VPC configurations
